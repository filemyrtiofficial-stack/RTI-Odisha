...
const faqs = [
  ...
  {
    question: "Which Odisha departments can I file RTI applications for?",
    answer: "You can file RTI applications for all Odisha Government departments including General Administration, Home, Finance, Revenue, School Education, Higher Education, Health & Medical Education, Public Works (R&B), Power Development, Jal Shakti, Agriculture, Forest & Environment, Industries & Commerce, Tourism, Housing & Urban Development, Rural Development & Panchayati Raj, Social Welfare, Labour & Employment, Transport, and many more.",
  },
  {
    question: "What documents do I need to file an RTI?",
    answer: "For filing an RTI in Odisha, you primarily need to clearly describe the information you're seeking. No identity proof is mandatory for filing, but having Aadhaar or voter ID helps for communication purposes. For BPL fee exemption, you'll need your BPL card.",
  },
  {
    question: "Can I file RTI anonymously?",
    answer: "Yes, we offer anonymous RTI filing services for Odisha departments where your identity is protected throughout the process. Our team files the application on behalf of our organization, ensuring your privacy while exercising your right to information.",
  },
];
        ...
        <AnimatedSection animation="fadeIn" delay={200}>
          <div className="text-center mb-14">
            ...
            <p className="text-base md:text-lg font-normal text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Everything you need to know about RTI filing in Odisha
            </p>
          </div>
        </AnimatedSection>
