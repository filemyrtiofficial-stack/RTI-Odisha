        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <AnimatedSection animation="slideUp" delay={300}>
            <h1 className="mb-6 text-4xl md:text-5xl lg:text-6xl font-bold leading-tight text-white">
              File RTI Online in <span style={{ color: '#CFE4F7', fontWeight: 800, letterSpacing: '0.5px' }}>Odisha</span>
            </h1>
          </AnimatedSection>
          ...
          <AnimatedSection animation="slideUp" delay={400}>
            <p className="text-lg md:text-xl text-white mb-10 max-w-3xl mx-auto leading-relaxed">
              Exercise your constitutional right to information. File RTI applications for any Odisha Government department with our trusted, legal assistance.
            </p>
          </AnimatedSection>
          ...
          <AnimatedSection animation="fadeIn" delay={700}>
            <p className="text-white/80 text-base md:text-lg mb-8">
              Trusted by citizens across Odisha
            </p>
          </AnimatedSection>
