/**
 * ============================================================================
 * Odisha COMPREHENSIVE RTI FORM
 * ============================================================================
 * 
 * Purpose: Main RTI application form for Odisha homepage. Collects user
 *          information and RTI query, then submits to backend API.
 * 
 * State Usage: Odisha (active) - Used only on homepage
 * 
 * Features:
 ...
 * 
 * Used by: Home.tsx (Odisha homepage)
 * ============================================================================
 */
  ...
  const onSubmit = async (data: typeof formData) => {
    try {
      ...
      await consultationsAPI.createPublic({
        ...
        state_slug: 'odisha',
        source: 'odisha_comprehensive_form'
      });
            ...
            <AnimatedSection animation="slideRight" delay={200}>
              <div className="flex flex-col w-full">
                ...
                <p className="text-base md:text-lg font-normal text-gray-600 mb-7 leading-relaxed">
                  Talk to our RTI experts to understand whether your query qualifies under the Right to Information Act, 2005. Get guidance on the correct Odisha Government department before filing.
                </p>

                <div className="space-y-4">
                  {[
                    "Free eligibility check for your RTI query",
                    "Guidance on the correct Odisha department",
