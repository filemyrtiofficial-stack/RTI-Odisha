/**
 * ============================================================================
 * HOMEPAGE - Odisha-SPECIFIC
 * ============================================================================
 * 
 * Purpose: Main landing page for the RTI platform, specifically configured
 *          for Odisha state.
 * 
 * State Usage: Odisha (active) - This is the primary homepage
 * 
 * Key Features:
 * - Hardcoded to use Odisha state data
 * - Uses lazy-loaded Odisha-specific components
...
// ====== Odisha-SPECIFIC COMPONENTS (Lazy Loaded) ======
// All Odisha components are state-specific and used only on homepage
...
export const Home: React.FC = () => {
  ...
  // Homepage is hardcoded to Odisha state
  const { stateData, isLoading } = useStateData('odisha');
  ...
  // ====== SEO METADATA ======
  const pageTitle = `File RTI Online in Odisha - FileMyRTI`;
  const pageDescription = `File RTI online in Odisha with FileMyRTI. Get expert-drafted RTI applications and appeals for Odisha Government departments, Secretariat and district offices from home.`;
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "RTI (Right to Information) is a fundamental right under the RTI Act 2005 that allows any Indian citizen to request information from public authorities. You can file RTI applications to seek information about government activities, decisions, public expenditure, and services provided by Odisha government departments."
        }
      },
      {
        "@type": "Question",
      ...
      {
        "@type": "Question",
        "name": "Which Odisha departments can I file RTI applications for?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "You can file RTI applications for all Odisha Government departments including General Administration, Home, Finance, Revenue, School Education, Higher Education, Health & Medical Education, Public Works (R&B), Power Development, Jal Shakti, Agriculture, Forest & Environment, Industries & Commerce, Tourism, Housing & Urban Development, Rural Development & Panchayati Raj, Social Welfare, Labour & Employment, Transport, and many more."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "For filing an RTI in Odisha, you primarily need to clearly describe the information you're seeking. No identity proof is mandatory for filing, but having Aadhaar or voter ID helps for communication purposes. For BPL fee exemption, you'll need your BPL card."
        }
      },
      {
        "@type": "Question",
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Yes, we offer anonymous RTI filing services for Odisha departments where your identity is protected throughout the process. Our team files the application on behalf of our organization, ensuring your privacy while exercising your right to information."
        }
      }
    ]
  };
    ...
    <>
      ...
      <div className="min-h-screen flex flex-col">
        <main id="main-content" className="flex-grow" role="main" aria-label="Main content" style={{ paddingTop: 0 }}>
            ...
            <div className="bg-primary-600 pt-12 pb-12" data-loading>
              <div className="container-responsive max-w-7xl mx-auto px-4">
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-4 leading-tight">
                  File RTI Online for Odisha Government Departments
                </h1>
              </div>
            </div>
          }>
          ...
          {/* 13. List of Odisha government departments supported */}
          <Suspense fallback={<div className="min-h-[400px]" />}>
            <RajasthanDepartmentsCoveredSection />
          </Suspense>

          {/* 9. RTI Templates for Odisha (letter templates/resources) */}
          <Suspense fallback={<div className="min-h-[400px]" />}>
